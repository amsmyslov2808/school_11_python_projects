# 1 некорректный ввод размера поля
# 2 комп стрелляет в уже выстрелленое поле
# 3 игрок 😊 может стреллять в выстрелленое поле
# 4 отсутсвтует предложение повторить игру ещё раз
# 5 пользователь может ввести некорректное значение в координаты выстрела
# 6 рамочка для поля (доп задача)
# 7 добавить разделители и название раунда
